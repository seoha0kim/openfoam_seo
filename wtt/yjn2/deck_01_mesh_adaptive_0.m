function out = model
%
% deck_01_mesh_adaptive_0.m
%
% Model exported on Sep 15 2020, 17:42 by COMSOL 5.5.0.359.
...
model.component('comp1').view('view1').axis.set('xmin', -7.977536678314209);
model.component('comp1').view('view1').axis.set('xmax', 13.97753620147705);
model.component('comp1').view('view1').axis.set('ymin', -5.861049652099609);
model.component('comp1').view('view1').axis.set('ymax', 5.861049652099609);
...
model.component('comp1').mesh('mesh1').run('fq2');
model.component('comp1').mesh('mesh1').feature('fq2').feature('size1').set('hauto', 6);
model.component('comp1').mesh('mesh1').run('fq2');
model.component('comp1').mesh('mesh1').feature('fq2').feature('size1').set('hauto', 7);
model.component('comp1').mesh('mesh1').run('fq2');
model.component('comp1').mesh('mesh1').feature('fq2').feature('size1').set('hauto', 8);
model.component('comp1').mesh('mesh1').run('fq2');
...
model.study('std2').feature('stat').activate('spf2', true);
...
model.component('comp1').physics('spf2').feature('inl1').set('U0in', '1e-3');
...
model.result('pg1').run;
model.result('pg1').run;
model.result('pg1').feature('surf1').set('colortable', 'DiscoLight');
...
model.result('pg1').feature('surf1').set('rangecolormax', '0.0001');
model.result('pg1').run;
model.result('pg1').feature('surf1').set('rangecolormax', '0.0005');
model.result('pg1').run;
model.result('pg1').run;
...
model.study('std1').feature('wdi').activate('spf3', true);
model.study('std1').feature('time').activate('spf3', true);
model.study('std2').feature('stat').activate('spf3', true);
...
model.result('pg3').run;
model.result('pg3').feature('surf1').set('expr', 'spf3.U');
...
model.component('comp1').mesh('mesh1').run('ada1');
