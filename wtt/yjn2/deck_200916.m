...
% %%
function [model,sb] = deck_200916(varargin)
...
model.study('std2').feature('time').set('tlist', 'range(0,0.1,.9)*18 1+range(0,1/2^8,2^4)*18');
...
model.sol('sol2').feature('t1').set('tlist', 'range(0,0.1,.9)*18 1+range(0,1/2^8,2^4)*18');
