...
% imsi.m
%
% Model exported on Sep 17 2020, 15:16 by COMSOL 5.5.0.359.
...
model.study('std2').feature('time').set('tlist', 'range(0,0.1,.9)*1.22e+01 range(1,1/2^6,2^4)*1.22e+01');
...
model.sol('sol2').feature('t1').set('tlist', 'range(0,0.1,.9)*1.22e+01 range(1,1/2^6,2^4)*1.22e+01');
...
model.result.numerical.create('num1', 'IntLine');
model.result.numerical('num1').set('data', 'dset2');
model.result.numerical('num1').set('intorder', 4);
model.result.numerical('num1').set('intsurface', 'off');
model.result.numerical('num1').set('method', 'auto');
model.result.numerical('num1').selection.named('box1');

model.sol('sol2').getSizeMulti;
model.sol('sol2').getSize;
...
model.result.numerical('num1').set('intsurface', 'off');
model.result.numerical('num1').set('method', 'auto');
model.result.numerical('num1').selection.named('box2');
...
model.result.numerical('num1').set('intsurface', 'off');
model.result.numerical('num1').set('method', 'auto');
model.result.numerical('num1').selection.named('box3');
...
model.label('rib_upper_laminarT_Re150.mph');
