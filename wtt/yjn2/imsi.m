...
% imsi.m
%
% Model exported on Sep 16 2020, 17:43 by COMSOL 5.5.0.359.
...
model.study('std1').feature('time').set('tlist', 'range(0,0.1,.9)*18 1+range(0,1/2^8,2^4)*18');
...
model.study('std1').feature('time').set('notsolnum', 'last');
...
model.study('std2').feature('time').set('tlist', 'range(0,0.1,.9)*18 range(1,1/2^8,2^4)*18');
...
model.sol('sol2').feature('v1').set('control', 'time');
model.sol('sol2').create('t1', 'Time');
model.sol('sol2').feature('t1').set('tlist', 'range(0,0.1,.9)*18 range(1,1/2^8,2^4)*18');
model.sol('sol2').feature('t1').set('plot', 'off');
model.sol('sol2').feature('t1').set('plotgroup', 'pg1');
model.sol('sol2').feature('t1').set('plotfreq', 'tout');
model.sol('sol2').feature('t1').set('probesel', 'all');
...
model.study('std1').feature('time').set('tlist', 'range(0,0.1,.9)*18 range(1,1/2^8,2^4)*18');
...
model.result('pg4').set('data', 'dset2');
model.result('pg3').run;
model.result('pg3').setIndex('looplevel', 3851, 0);
model.result('pg3').run;
...
model.result.dataset('int1').selection.named('box1');
model.result('pg5').run;
model.result('pg5').set('data', 'int1');
model.result('pg5').run;
model.result('pg5').run;
...
model.result('pg5').run;
model.result('pg5').run;
model.result('pg5').feature('ptgr1').set('expr', 'spf.T_stressx');
model.result('pg5').feature('ptgr1').set('descr', 'Total stress, x component');
model.result('pg5').run;
model.result('pg5').run;
...
model.result('pg5').setIndex('looplevelindices', '2-3851', 0);
model.result('pg5').setIndex('looplevelindices', '2:3851', 0);
model.result('pg5').run;
model.result('pg5').setIndex('looplevelindices', 'range(2,3851)', 0);
model.result('pg5').run;
