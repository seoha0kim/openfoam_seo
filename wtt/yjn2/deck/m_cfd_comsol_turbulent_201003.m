...
% upper
% [Oct 3, 2020 2:37 PM] Distance: 19959.15556 [m], (19959.15556, -8.381909993E-7) [m].
% Point 1 (del1) to 324 (del1). Average coordinates: (157333.0083, -1067.977166) [m].  Points: 1, 324 (del1).
% [Oct 3, 2020 2:38 PM] Distance: 4491.055829 [m], (1907.149869, 4066.000718) [m].
% Point 1 (del1) to 32 (del1). Average coordinates: (148307.0054, 965.0231933) [m].  Points: 1, 32 (del1).

% lower
% [Oct 3, 2020 2:44 PM] Distance: 20889.33792 [m], (20889.33792, -2.328670234E-8) [m].
% Point 1 (del1) to 309 (del1). Average coordinates: (157127.4098, -23560.91607) [m].  Points: 1, 309 (del1).
% [Oct 3, 2020 2:44 PM] Distance: 3986.227903 [m], (688.150216, 3926.380289) [m].
% Point 8 (del1) to 23 (del1). Average coordinates: (148710.9068, -21829.75621) [m].  Points: 8, 23 (del1).
...
% maximize B
sb.geo.x_c = 157333.0083/1e3;
sb.geo.B = 19959.15556/1e3;

% centering
% sb.geo.y_c = 965.0231933/1e3;
sb.geo.y_c = (-1067.977166 + 2725)/1e3;
sb.geo.D = 4066.000718/1e3;
...
sb.geo.B = 20889.33792/1e3;

% centering
% sb.geo.y_c = -21829.75621/1e3;
sb.geo.y_c = (-23560.91607 + 2632)/1e3;
sb.geo.D = 3926.380289/1e3;
...
model.component('comp1').geom('geom1').feature('imp1').set('filename', ...
    '../yjn2_cfd_deck_200915.dxf');
    % '/media/sbkim/2266B8F966B8CEB3/git/openfoam_seo/wtt/yjn2/');
