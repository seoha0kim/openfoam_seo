...
% imsi.m
%
% Model exported on Oct 20 2020, 17:31 by COMSOL 5.5.0.359.
...
model.param.set('seo_U_in', '0.007834[m/s]');
model.param.set('seo_B', '0.279700[m]');
...
model.component('comp1').geom('geom1').feature('mov1').setIndex('displx', '-164.707064', 0);
model.component('comp1').geom('geom1').feature('mov1').setIndex('disply', '-17.860000', 0);
...
model.result.numerical('num1').set('expr', '(spf.nxmesh*p + spf.rho*spf.u_tau*spf.u_tangx/spf.uPlus) / (1/2*spf.rho*(seo_U_in^2))');
model.result.numerical('num1').run;
model.result.numerical('num1').set('solnumindices', 1);
model.result.numerical('num1').set('outersolnum', 1);
model.result.numerical('num1').set('dataisaxisym', false);
...
model.result.numerical('num1').set('expr', '(spf.nymesh*p + spf.rho*spf.u_tau*spf.u_tangy/spf.uPlus) / (1/2*spf.rho*(seo_U_in^2))');
model.result.numerical('num1').run;
model.result.numerical('num1').set('solnumindices', 1);
model.result.numerical('num1').set('outersolnum', 1);
model.result.numerical('num1').set('dataisaxisym', false);
...
model.result.numerical('num1').set('expr', '((spf.nxmesh*p + spf.rho*spf.u_tau*spf.u_tangx/spf.uPlus)*y + (spf.nymesh*p + spf.rho*spf.u_tau*spf.u_tangy/spf.uPlus)*-x)/(1/2*spf.rho*(seo_U_in^2))');
model.result.numerical('num1').run;
model.result.numerical('num1').set('solnumindices', 1);
model.result.numerical('num1').set('outersolnum', 1);
model.result.numerical('num1').set('dataisaxisym', false);
...
model.param.set('seo_U_in', '0.052227[m/s]');
...
model.param.set('seo_U_in', '0.522274[m/s]');
...
model.param.set('seo_U_in', '5.222735[m/s]');
...
model.label('deck_upper_a000_turbulent_Re100000.mph');

model.component('comp1').geom('geom1').feature('imp1').set('alllayers', {'0' 'DRAW' 'CS-LIN3' 'CS-STEL-MAJR' 'CS-MIS2' '' 'CS-STLC' 'DEFAULT'});
model.component('comp1').geom('geom1').run('co1');
model.component('comp1').geom('geom1').create('mir1', 'Mirror');
model.component('comp1').geom('geom1').feature.move('mir1', 5);
...
model.component('comp1').geom('geom1').feature('mir1').set('pos', [0 0.1]);
model.component('comp1').geom('geom1').run('mir1');
model.component('comp1').geom('geom1').feature('mir1').set('pos', [0 0]);
model.component('comp1').geom('geom1').run('mir1');
