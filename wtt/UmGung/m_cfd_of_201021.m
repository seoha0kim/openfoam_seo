...
% %%
function [model,sb] = m_cfd_of_201021(varargin)
%
...
% %%
% cd ~/Work/git/openfoam_seo/wtt/UmGung/

% %%
% model = mphload('imsi.mph')
% model = mphload('tower_large.mph')
model = mphload('../../../deck_upper_a000_turbulent_SST_Re200000.mph')
...
sb.id_box = [5 6 7 1 2 3 4];
            case 3
                s_geo = 'upper_a000';
model = mphload('../../../deck_upper_a000_turbulent_SST_Re200000.mph')
sb_ii = load(sprintf('deck_%s_turbulent_SST_Re200000.mat',s_geo))
...
fid = fopen(sprintf('blockMeshDict_UmGung_%s_%s.foam', ...
