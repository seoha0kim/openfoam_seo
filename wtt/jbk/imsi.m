...
% imsi.m
%
% Model exported on Sep 24 2020, 11:33 by COMSOL 5.5.0.359.
...
model.component('comp1').geom('geom1').feature('imp1').set('filename', '/home/sbkim/Work/git/openfoam_seo/wtt/jbk/dxf/pylon_cfd.dxf');
...
model.component('comp1').selection('box6').set('ymin', -0.8);
model.component('comp1').selection('box6').set('ymax', -0.7);
...
model.component('comp1').selection('box7').set('ymin', 0.7);
model.component('comp1').selection('box7').set('ymax', 0.8);
...
model.component('comp1').physics('spf').feature('inl1').selection.named('box4');
model.component('comp1').physics('spf').feature('inl1').set('U0in', 1.2);
model.component('comp1').physics('spf').create('out1', 'OutletBoundary', 1);
model.component('comp1').physics('spf').feature('out1').selection.named('box5');
model.component('comp1').physics('spf').create('sym1', 'Symmetry', 1);
model.component('comp1').physics('spf').feature('sym1').selection.named('box6');
model.component('comp1').physics('spf').feature('sym1').selection.named('box7');
model.component('comp1').physics('spf').feature.duplicate('sym2', 'sym1');
model.component('comp1').physics('spf').feature('sym2').selection.named('box6');
...
model.component('comp1').mesh('mesh1').feature.duplicate('fq2', 'fq1');
...
model.component('comp1').mesh('mesh1').feature('fq2').feature('size1').selection.set([2 3]);
model.component('comp1').mesh('mesh1').feature('fq2').selection.set([2]);
model.component('comp1').mesh('mesh1').feature.duplicate('fq3', 'fq2');
model.component('comp1').mesh('mesh1').feature('fq3').selection.set([1]);
