...
model.component('comp1').geom('geom1').feature('imp1').set('filename', ...
    '/home/sbkim/Work/git/openfoam_seo/wtt/jbk/dxf/pylon_cfd.dxf');
...
model.component('comp1').geom('geom1').feature('del1').selection('input').set('csol1(1)', [7 8 9 10 19 20]);
% model.component('comp1').geom('geom1').run('del1');

% %%
% [Sep 24, 2020 11:02 AM] Length: 20.82842712 [m]. Edges: 18.
% [Sep 24, 2020 11:02 AM]
% Distance: 6.946221995 [m], (6, 3.5) [m].
% Point 1 (del1) to 18 (del1). Average coordinates: (2058.72311, 1886.344675) [m].  Points: 1, 18 (del1).
...
model.component('comp1').geom('geom1').feature('mov1').setIndex('displx', '-2058.72311', 0);
model.component('comp1').geom('geom1').feature('mov1').setIndex('disply', '-1886.344675', 0);
