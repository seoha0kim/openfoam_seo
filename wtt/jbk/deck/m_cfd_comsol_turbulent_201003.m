...
% max B
% [Oct 5, 2020 5:30 PM] Distance: 16100.0 [m], (16100.0, 0) [m].
% Point 1 (imp1(2)) to 11 (imp1(2)). Average coordinates: (21457.55571, 19514.03991) [m].
% Points: 1, 11 (imp1(2)).

% D
% [Oct 5, 2020 5:44 PM] Distance: 5695.572513 [m], (4371.72, 3650.7) [m].
% Point 5 (imp1(2)) to 11 (imp1(1)). Average coordinates: (18621.69571, 18913.68991) [m].
% Points: 5 (imp1(2)); 11 (imp1(1)).

% center
% [Oct 5, 2020 5:46 PM] Distance: 10043.44 [m], (10043.44, 2.939486876E-8) [m].
% Point 5 (imp1(2)) to 7 (imp1(2)). Average coordinates: (21457.55571, 17088.33991) [m].
% Points: 5, 7 (imp1(2)).

% fence
% [Oct 5, 2020 5:48 PM] Distance: 0.4 [m], (0.4, 0) [m].  Point 1 (imp2(2)) to 3 (imp2(2)).
% Average coordinates: (880.6135465, 65.00383976) [m].  Points: 1, 3 (imp2(2)).

% [Oct 5, 2020 5:52 PM] Distance: 399.9999985 [m], (399.9999985, -1.39734766E-8) [m].
...
% maximize B
sb.geo.x_c = 21457.55571/1e3;
sb.geo.B = 16100/1e3;

% centering
sb.geo.y_c = (17088.33991 + 1848)/1e3;
sb.geo.D = 3650.7/1e3;
