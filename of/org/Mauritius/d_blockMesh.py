...
f_bl.write('\ndx: %f, %f'%(dx_old[0]*1e3,dx_old[1]*1e3))
...
n_g0[[0,18,36,50,64,68,74]] = n_g0[0]
n_g0[[1,19,37,51,65,69,75]] = n_g0[1]
n_g0[[2,20,38,52]] = n_g0[2]
n_g0[[3,21,39,53]] = n_g0[3]
n_g0[[4,22,40,54]] = n_g0[4]
n_g0[[5,23,41,55]] = n_g0[5]
n_g0[[6,24,42,56]] = n_g0[6]
n_g0[[7,25]] = n_g0[7]
n_g0[[8,26]] = n_g0[8]
n_g0[[9,27]] = n_g0[9]
n_g0[[10,28]] = n_g0[10]
n_g0[[11,29,43,57]] = n_g0[11]
n_g0[[12,30,44,58]] = n_g0[12]
n_g0[[13,31,45,59]] = n_g0[13]
n_g0[[14,32,46,60]] = n_g0[14]
n_g0[[15,33,47,61]] = n_g0[15]
n_g0[[16,34,48,62,66,72,78]] = n_g0[16]
n_g0[[17,35,49,63,67,73,79]] = n_g0[17]
n_g0[[70,76]] = n_g0[76]
n_g0[[71,77]] = n_g0[77]
    ...
    if True:
        ...
        for ii in range(np.shape(of_block)[0]):
            if (ii == 0):
                ...
                # f.write('    hex (%s) (%03d %03d 1) simpleGrading (%7.3f %7.3f 1)\n'% \
                f.write('    hex (%s) (%03d %03d 1) edgeGrading (%.1e %.1e %.1e %.1e %.1e %.1e %.1e %.1e 1 1 1 1)\n'% \
                    (' '.join( '%03d'%of_block[ii][jj] for jj in range(8) ), n_g0[ii], n_g1[17], 1, 1, 1, 1, 1/R_g0[ii,2], 1/R_g0[ii,3], 1/R_g0[ii,3], 1/R_g0[ii,2] ) )
            elif ((ii > 74) and (ii < 79)):
                # f.write('    hex (%s) (%03d %03d 1) simpleGrading (%7.3f %7.3f 1)\n'% \
                f.write('    hex (%s) (%03d %03d 1) edgeGrading (%.1e %.1e %.1e %.1e %.1e %.1e %.1e %.1e 1 1 1 1)\n'% \
                    (' '.join( '%03d'%of_block[ii][jj] for jj in range(8) ), n_g0[ii], n_g1[79], 1, 1, 1, 1, R_g0[ii,2], R_g0[ii,3], R_g0[ii,3], R_g0[ii,2] ) )
                ...
                # f.write('    hex (%s) (%03d %03d 1) simpleGrading (%7.3f %7.3f 1)\n'% \
                f.write('    hex (%s) (%03d %03d 1) edgeGrading (%.1e %.1e %.1e %.1e %.1e %.1e %.1e %.1e 1 1 1 1)\n'% \
                    (' '.join( '%03d'%of_block[ii][jj] for jj in range(8) ), n_g0[17], n_g1[ii], R_g0[ii,0], R_g0[ii,1], R_g0[ii,1], R_g0[ii,0], 1, 1, 1, 1 ) )
